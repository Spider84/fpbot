module Farmpage
  class Processor
    ...
    def initialize(task = nil, logger, device_id, host, port, appium_port)
    ...
    def process!
      platform_processor = "Farmpage::Facebook".constantize.new(@task, @avd, @proxy, @logger, @device_id, @host, @port, @appium_port)
